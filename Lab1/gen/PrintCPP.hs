...
instance Print Exp where
  prt i e = case e of
   ...
   EQConst qconsts -> prPrec i 16 (concatD [prt 0 qconsts])
...
instance Print QConst where
  prt i e = case e of
   ...
   TypeName type' -> prPrec i 0 (concatD [prt 3 type'])
...
instance Print Type where
  prt i e = case e of
   TString  -> prPrec i 3 (concatD [doc (showString "string")])
   TInt  -> prPrec i 2 (concatD [doc (showString "int")])
   TDouble  -> prPrec i 2 (concatD [doc (showString "double")])
   TTemplate id targ -> prPrec i 3 (concatD [prt 0 id , doc (showString "<") , prt 0 targ , doc (showString ">")])
   TQConst qconsts -> prPrec i 1 (concatD [prt 0 qconsts])
